...
export function SubscriberChartSkeleton() {
  return (
...
export function LatestInvestorsSkeleton() {
  return (
    <div
...
export function InvestorsMobileSkeleton() {
  return (
...
// Additional skeleton for subscribers table
